...
export default function Footer() {
  const socialLinks = [
    {
      name: "TikTok",
      href: "https://www.tiktok.com/@ridexng",
      icon: (
    ...
    {
      name: "Twitter",
      href: "https://twitter.com/ngridex",
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: "Instagram",
      href: "https://www.instagram.com/ngridex",
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
  ...
  const platformLinks = [
    ...
    { name: "Register Company", href: "/registration_company" },
  ];
  ...
  const appLinks = [
    { name: "Customer App (iOS)", href: "#" },
    { name: "Customer App (Android)", href: "#" },
    { name: "Rider App (iOS)", href: "#" },
    { name: "Rider App (Android)", href: "#" },
  ];
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 sm:gap-12 mb-12">
          ...
          <div>
            ...
            >
              ...
              <div>
                <h3 className="text-2xl font-bold">RIDEX</h3>
                <p className="text-sm text-gray-400">Logistics Platform</p>
              </div>
            </motion.div>
            <p className="text-gray-400 text-sm leading-relaxed mb-6">
              Nigeria's trusted delivery platform connecting customers,
            ...
            <ul className="space-y-3">
              {platformLinks.map((link) => (
                <li key={link.name}>
                  <Link
                    href={link.href}
                    className="text-gray-400 hover:text-green-400 transition-colors inline-flex items-center gap-2 group text-sm"
                  >
                    <span>{link.name}</span>
                    <svg
          ...
          {/* Download Apps */}
          <div>
            <h4 className="text-lg font-semibold mb-6">Download Apps</h4>
            <ul className="space-y-3">
              {appLinks.map((link) => (
                <li key={link.name}>
                  <Link
